import { createAndDisplayTask } from './todos-logic';
import { createProject } from './projects-logic';
...
const createPopUp = (project_data) => {
  ...
  heading.innerText = `Create Task for ${title}`;
  form.append(heading);
  ...
  create_task_button.addEventListener('click', createAndDisplayTask);
